...
static char const * trans_table_contype[] = {
  ...
  [MTMETIS_CONTYPE_CLS_QUADRATIC] = MTMETIS_STR_CONTYPE_CLS_QUADRATIC,
  [MTMETIS_CONTYPE_CLS_RDREAD] = MTMETIS_STR_CONTYPE_CLS_RDREAD,
  [MTMETIS_CONTYPE_CLS_RDWRITE] = MTMETIS_STR_CONTYPE_CLS_RDWRITE,
